...
<div class="content">
	...
	<form id="frm" action="./addressUpdateForm" method="post">
		<table class="table">
			<tr>
				<th><span>배송지명</span></th>
				<td><input id="adrName" type="text" name="adrName" value="${address.adrName}"></td>
			</tr>
			<tr>
				<th><span>성명</span> <img src="/Project_final/resources/images/icon/ico_required.png"></th>
				<td><input id="receiver" class="must" type="text" name="receiver" value="${address.receiver}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><select id="phone_first_select" name="phone_first_select" style="width: 60px;height: 26px; 
				border:1px solid #e7e7e7;margin-right: 10px;"<%%>>
						<option>${address.phone1}</option>
						<option value="010">010</option>
						<option value="011">011</option>
						<option value="016">016</option>
						<option value="017">017</option>
					...
					<input class="phone_first" name="phone1" type="hidden" value="${address.phone1}">
					<input class="phone_middle must" name="phone2" type="text" style="width:70px;margin-right:10px;margin-left:5px;" value="${address.phone2}">-
					<input class="phone_last" name="phone3" type="text" style="width:70px;margin-left:5px;" value="${address.phone3}">
				</td>
			</tr>
		</table>
	</form>
